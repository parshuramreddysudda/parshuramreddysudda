  ...
  return (
      <div className="pb-6 bg-white sm:pb-8 lg:pb-12">
          <header className="mb-8 border-b">
              <div className="flex items-center justify-between px-4 mx-auto max-w-screen-2xl md:px-8">
          ...
          <section className="px-4 mx-auto max-w-screen-2xl md:px-8">
              <div className="flex flex-wrap justify-between mb-8 md:mb-16">
                  <div className="flex flex-col justify-center w-full mb-6 lg:w-1/3 lg:pt-48 lg:pb-24 sm:mb-12 lg:mb-0">
                      <h1 className="mb-4 text-4xl font-bold text-black-800 sm:text-5xl md:text-6xl md:mb-8">Find your<br />style online</h1>
                  ...
                  <div className="flex w-full mb-12 lg:w-2/3 md:mb-16">
                      <div className="relative z-10 -ml-12 overflow-hidden transition duration-300 ease-in-out delay-150 bg-gray-100 rounded-lg shadow-lg top-12 md:top-16 left-12 md:left-16 lg:ml-0 md:hover:-translate-x-16 md:hover:-translate-y-8">
                          <img src="https://images.unsplash.com/photo-1542340916-951bb72c8f74?auto=format&q=75&fit=crop&w=550&h=550" loading="lazy" alt="Photo by Kaung Htet" className="object-cover object-center w-full h-full" />
                      </div>

                      <div className="overflow-hidden transition duration-300 ease-in-out delay-150 bg-gray-100 rounded-lg shadow-lg md:hover:-translate-x-16 md:hover:-translate-y-8">
                          <img src="https://images.unsplash.com/photo-1586295166487-b265f7e83a7f?auto=format&q=75&fit=crop&w=550&h=550" loading="lazy" alt="Photo by Manny Moreno" className="object-cover object-center w-full h-full" />
                      </div>
                  </div>
              </div>
              ...
              <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
                  <div className="flex w-64 h-12 overflow-hidden border divide-x rounded-lg">
                      <a href="#" className="flex items-center justify-center w-1/3 text-gray-500 transition duration-100 hover:bg-gray-100 active:bg-gray-200">Men</a>
                      <a href="#" className="flex items-center justify-center w-1/3 text-gray-500 transition duration-100 hover:bg-gray-100 active:bg-gray-200">Women</a>
                      <a href="#" className="flex items-center justify-center w-1/3 text-gray-500 transition duration-100 hover:bg-gray-100 active:bg-gray-200">Teens</a>
                  </div>
